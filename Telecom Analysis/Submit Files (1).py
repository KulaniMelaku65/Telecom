...
columns_to_show=['MSISDN/Number', 'Satisfaction_Score', 'Experience_Score', 'Engagement_Score' ]
selected_columns_df=df[columns_to_show].head
export_df=df[columns_to_show]
export_df.to_csv('exported_data.csv', index=False)
print(selected_columns_df)
